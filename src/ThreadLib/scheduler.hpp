...
public:
     ...
     */
    void schedule_periodic(const TimePoint& first_time, const Duration& interval, Task task);
...
private:
    ...
    std::priority_queue<ScheduledTask, std::vector<ScheduledTask>, TaskComparer> tasks_;
    std::mutex mutex_;
